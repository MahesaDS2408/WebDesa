                ...
                <div class="swiper-wrapper pb-70 pt-5">
                  <div class="swiper-slide">
                    <div class="card-grid-3 hover-up wow animate__animated animate__fadeIn">
                      <div class="text-center card-grid-3-image"><a href="<?php base_url() ?>/berita/<?= date('Y') ?>/judul">
                          <figure><img alt="Webdesa" src="assets/imgs/page/homepage1/img-news1.png"></figure></a></div>
                      <div class="card-block-info">
                        <div class="tags mb-15"><a class="btn btn-tag" href="<?php base_url() ?>/berita/<?= date('Y') ?>/judul">Kategori</a></div>
                        <h5><a href="<?php base_url() ?>/berita/<?= date('Y') ?>/judul">21 Job Interview Tips: How To Make a Great Impression</a></h5>
